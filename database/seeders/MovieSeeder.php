...
class MovieSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('movies')->insert([
            'title' => 'Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title Movie with long title',
            'duration' => '50',
            ...
            'viewCount' => 1000,
            'rating' => 9,
            'synopsis' => 'Movie with long title Synopsis'
        ]);
