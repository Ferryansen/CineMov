                  ...
                  <div class="container-fluid header" style="background-image: url({{$b->banner_url}});
                    ...
                    <div class="container header-detail ms-3 py-3">
                      ...
                      <div class="d-flex justify-content-start align-items-center">
                        <a href = "{{route('admin.movie.detail', ['movie_id' => $b->id])}}" role="button" class="bg-gradient-primary text-white rounded-pill px-3 py-1 fw-bold mx-1 fs-6 text-decoration-none pe-auto">DETAILS</a>
                      </div>
        ...
        @foreach ($movie as $m)
            ...
            <div class="card p-0 border-0 radius-none card-height">
                ...
                <p class="card-text mb-0">
                    ...
                    <a href="{{route('admin.movie.detail', ['movie_id' => $m->id])}}" class="btn bg-card-button-gradient text-white border-0 rounded-pill">SETTINGS</a>
                    </div>
                </div>
            </div>
            </div>
